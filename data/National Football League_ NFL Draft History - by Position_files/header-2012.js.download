...
(function() {
  "use strict";
  var Constants, encQS, useDebug;

  Constants = nfl.constants;

  encQS = encodeURIComponent;

  useDebug = window.location.search.indexOf("DEBUG") > -1;
  ...
  */
  window.nfl.Y.namespace("NFL").LoadHeader2012 = function(config) {
    ...
    Y = YUI({
      groups: {
        "header-2012": {
          ...
          comboBase: [Constants.NFL_COMBO_URL, "?", encQS(Constants.ASSET_VERSION + Constants.ASSET_BUILD), "&b=", encQS("yui3/static/" + Constants.ASSET_VERSION + "/scripts"), useDebug ? "&debug" : "", "&f="].join(""),
          comboSep: ",",
          base: (function() {
          ...
          modules: {
            ...
            "hp-teams-links": {
              ...
              requires: ["node", "substitute", "data-teams"]
            },
            "header-2012-base": {
              path: "header-base.js",
            ...
            "header-main-nav": {
              ...
              requires: ["node", "event-mouseenter", "event-touch", "header-2012-base", "header-anim-plugins", "plugin", "hp-teams-links", "event-custom", "shop-data"]
            },
            ...
            "hp-team": {
              ...
              requires: ["nfl-user", "node", "substitute", "header-2012-base", "data-teams", "hp-teams-links"]
            },
            "hp-fans": {
    ...
    */
    _loaderFn = function(Y) {
      ...
      */
      personalize = function() {
        ...
        Y.use("hp-user-greet", "hp-fantasy", "hp-team", "hp-fans", "hp-subscriptions", function() {
    ...
    _baseModules = [ "header-2012-base", "header-main-nav", "header-secondary-nav", "header-tertiary-content", "header-static-team-bar", "font-nflicons", _loaderFn ];
